/**
 * Rhythm Tab Component
 * Displays rhythm and groove analysis (swing, syncopation, quantization, evenness, beats)
 */
...
export function RhythmTab({ analysisData }: RhythmTabProps) {
    if (!analysisData.rhythm) {
        return <div className="daw-empty-state">No rhythm data available</div>;
    }
