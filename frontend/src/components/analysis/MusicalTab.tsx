/**
 * Musical Tab Component
 * Displays melody and harmonic analysis (pitch range, motifs, chords, progressions, cadences)
 */

import { Mic2, Radio } from 'lucide-react';
import type { AudioAnalysisResult } from '../../types/audio';

interface MusicalTabProps {
    analysisData: AudioAnalysisResult;
}

export function MusicalTab({ analysisData }: MusicalTabProps) {
    return (
